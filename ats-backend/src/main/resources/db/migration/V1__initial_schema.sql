-- HireFlow ATS — Initial schema (jobs + candidates + Talent Pool seed)
...
('Acme Technologies', 'Senior Software Engineer', 'Engineering', 'San Francisco, CA (Remote)',
 ...
 '100 Pine St, San Francisco, CA 94111', 37.7920, -122.4000, 'OPEN', 'FULL_TIME'),
('Pixel Creative', 'Product Designer', 'Design', 'New York, NY (Hybrid)',
 'Join our product design team to craft intuitive user experiences across our SaaS platform.',
 'Figma,UI/UX,Prototyping,User Research,Design Systems,HTML/CSS,Wireframing',
 '350 5th Ave, New York, NY 10118', 40.7484, -73.9967, 'OPEN', 'FULL_TIME'),
('Acme Technologies', 'DevOps Engineer', 'Engineering', 'Austin, TX (Remote)',
 ...
 '100 Congress Ave, Austin, TX 78701', 30.2672, -97.7431, 'OPEN', 'FULL_TIME'),
('GrowthMedia', 'Marketing Intern', 'Marketing', 'Chicago, IL (On-site)',
 ...
 '233 S Wacker Dr, Chicago, IL 60606', 41.8790, -87.6359, 'OPEN', 'INTERNSHIP'),
('DataBridge Inc', 'Data Analyst', 'Data', 'Seattle, WA (Hybrid)',
 ...
 '400 Broad St, Seattle, WA 98109', 47.6205, -122.3493, 'DRAFT', 'FULL_TIME'),
('Acme Technologies', 'Frontend Developer', 'Engineering', 'Denver, CO (Remote)',
 'Build pixel-perfect, accessible user interfaces with Angular and TypeScript.',
 'Angular,TypeScript,HTML/CSS,JavaScript,RxJS,SCSS,REST API',
 '1700 Lincoln St, Denver, CO 80203', 39.7476, -104.9876, 'CLOSED', 'CONTRACT');
