...
@Component({
  ...
  template: `
    ...
    <div class="projects-container">
      ...
      <h1 id="projects-page-title">Angular/Java Projects</h1>
      ...
      <div class="projects-grid" *ngIf="!loading && !error" role="list" aria-label="Project cards">
        <div *ngFor="let project of projects" class="project-card" role="listitem">
          ...
          <div class="project-links">
            <a *ngIf="project.githubUrl" [href]="project.githubUrl" target="_blank" rel="noopener noreferrer" class="link"
               [attr.aria-label]="'View ' + project.title + ' on GitHub (opens in new tab)'">
