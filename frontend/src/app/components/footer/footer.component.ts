      ...
      <div class="footer-content">
        ...
        <div class="footer-section">
          ...
          <ul class="footer-links" aria-label="Footer navigation links">
            ...
            <li><a href="/resume.html" target="_blank" rel="noopener noreferrer">Resume<span class="sr-only"> (opens in new tab)</span></a></li>
          </ul>
        </div>
          ...
          <ul class="footer-links" aria-label="Social media links">
            <li>
              <a href="https://github.com/clark22134" target="_blank" rel="noopener noreferrer" aria-label="GitHub profile (opens in new tab)">
                <svg width="18" height="18" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" focusable="false" role="img">
            ...
            <li>
              <a href="/linkedin.html" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile (opens in new tab)">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" role="img">
            ...
            <li>
              <a href="mailto:clark&#64;clarkfoster.com" aria-label="Send email to Clark Foster">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" focusable="false" role="img">
